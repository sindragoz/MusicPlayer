...
namespace WindowsFormsApplication2
{
    public partial class Form2 : Form
    {
        ...
        void fillprbr()
        {
            prbr.Add(progressBar1);
            prbr.Add(progressBar2);
            prbr.Add(progressBar3);
            prbr.Add(progressBar4);
            prbr.Add(progressBar5);
            prbr.Add(progressBar6);
            prbr.Add(progressBar7);
            prbr.Add(progressBar8);
