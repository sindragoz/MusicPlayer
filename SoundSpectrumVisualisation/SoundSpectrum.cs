...
namespace SoundSpectrumVisualisation
{
    ...
    public class SoundSpectrum : Control
    {
        ...
        private Image img = Image.FromFile("C:\\Users\\User\\Documents\\visual studio 2015\\Projects\\WindowsFormsApplication2\\SoundSpectrumVisualisation\\bin\\Debug\\glance.png");
      ...
      //  int zero_sectors = fftLength;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            SolidBrush br = new SolidBrush(spectrumColor);
            ...
            for (int i =0; i <fftLength ; i++)
            {
                ...
                for (int k = 1; k <= bricks;k++) {
                    ...
                    e.Graphics.DrawImage(img, h_sectors[i],Height- k * bricks_h, h_s_size, bricks_h);
